        ...
        <nav class="sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300">
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/">
                        <img class="w-full h-auto object-contain max-w-full"  src="/assets/images/logo.png" alt="" />
                    </router-link>
                    <!-- <a
                        href="javascript:;"
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/" @click="toggleMobileMenu">{{ $t('Mata Kuliah') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/data-mahasiswa" @click="toggleMobileMenu">{{ $t('Data Mahasiswa') }}</router-link>
                                    </li>
                                    <!-- <li>
